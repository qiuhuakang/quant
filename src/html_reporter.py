...
function switchTab(tab) {{
    ...
    const tabMap = {{
        'passed': {{ btn: 1, content: 'tab-passed' }},
        'excluded': {{ btn: 2, content: 'tab-excluded' }},
        'multi-passed': {{ btn: 3, content: 'tab-multi-passed' }},
        'multi-excluded': {{ btn: 4, content: 'tab-multi-excluded' }},
        'doji': {{ btn: 5, content: 'tab-doji' }}
    }};
